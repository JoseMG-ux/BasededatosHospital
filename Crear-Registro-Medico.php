            ...
            <form action="Crear-Registro-Medico.php" method="post" ENCTYPE="multipart/form-data">
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="inputEmail4" placeholder="Ej: Juan" name="nombre" required>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="inputPassword4">Apellido</label>
                        <input type="text" class="form-control" id="inputPassword4" placeholder="Ej: Ramirez" name="apellido" required>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="inputCity" placeholder="Ej: 6666-9999" name="telefono" required>
                    </div>
                    <div class="form-group col-md-4">
                        <label for="inputspec">Especialidad</label>
                        <select id="inputState" class="form-control" name="especialidad" required>
                ...
                <div class="form-row">
                    <div class="form-group mb-2">
                        ...
                        <input type="text" class="form-control" id="inputPassword2" placeholder="EJ: PSIQ451" name="codigo" required>
