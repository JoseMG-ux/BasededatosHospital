...
<body>
    ...
    <section class="py-5">
        ...
        <div class="container">
            ...
            @$especialidadHidden =     @$especialidad;
            ...
            if (@$buscar) {
                ...
                if (@$fila) {
                    while ($registro = mysqli_fetch_assoc($consulta)) {
                        ...
                        @$especialidadHidden = $registro["especialidad"];
            ...
            if (@$actualizar) {
                ...
                @$fila = mysqli_num_rows($consulta);
                if ($fila) {
                    $sql = "UPDATE medicos set  nombre='$nombre', apellido= '$apellido', telefono='$telefono', especialidad='$especialidadHidden'  where codigo ='$codigo'";
            ...
            echo "<form action=Editar-Registro-Medico.php method=post ENCTYPE=multipart/form-data>
                <div class='form-row' >
                 <div class='form-group col-md-6'>
                    ...
                    <input type='text' class='form-control'  name='nombre' placeholder='Ej: Juan' value=" . @$nombre . ">
                    
                </div>
                <div class='form-group col-md-6'>
                    <label for='inputPassword4'>Apellido</label>
                    <input type='text' class='form-control'  name='apellido' placeholder='Ej: Ramirez' value=" . @$apellido . ">
                </div>
        </div>
        ...
        <div class='form-row'>
            ...
            <div class='form-group col-md-4'>
                ...
                <select id='inputState' class='form-control' name='especialidad'>
                    <option  value='".@$especialidadHidden."' selected disabled hidden>" . @$especialidad . "</option>
        ...
        <div class='form-row'>
            ...
            <div class='form-group mx-sm-3 mb-2'>
                <input type='text' class='form-control' id='inputPassword2' name='codigo' placeholder='EJ: 455DFPSI' required value=" . @$codigo . " >
             </div>
            ...
            <input type=hidden name=especialidadHidden value=" . @$especialidad . " >
            </form> ";
            ?>
